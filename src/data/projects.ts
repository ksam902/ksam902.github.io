...
export const projects: Project[] = [
  {
    ...
    description: 'A modern, high-performance e-commerce solution with React and Node.js. Features include cart management, user authentication, and payment integration.',
    longDescription: `
  ...
  },
  {
    ...
    description: 'A collaborative task management application with real-time updates. Built with React, TypeScript, and Firebase.',
    longDescription: `
  ...
  },
  {
    ...
    description: 'An interactive data visualization dashboard for business metrics. Includes customizable charts and exportable reports.',
    longDescription: `
  ...
  },
  {
    ...
    description: 'A full-stack social media application with features like user profiles, posts, comments, and real-time notifications.',
    longDescription: `
